...
if redis:get(max.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'𝒖𝒔𝒆 ➪ : '..UserNameID..' .\nMSG : '..msgs..' .\nSTA : '..msg.TheRank..' .\niD : '..msg.sender_user_id_..' .',dl_cb,nil)
		else
...
elseif Text== "ايديي" or Text=="ايذيي" then 
  ...
  if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
  local USERCAR = utf8.len(USERNAME)
  SendMention(msg.chat_id_,data.id_,msg.id_,"𝒖𝒔𝒆 ➪ : "..USERNAME.."\niD : "..data.id_.." ",37,USERCAR)  
  return false
  end)
...
‏
  ...
  --=====================================
  elseif Text== "عزيز" or Text== "عز" or Text=="مطور كوين" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[𝐑𝐎𝐘.](https://t.me/ziz_6)")
end 
end 
